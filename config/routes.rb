...
Rails.application.routes.draw do
  ...
  get 'branding/logo.png' => 'branding#logo', as: :branding_logo
  get 'branding/favicon-:size.png' => 'branding#favicon', as: :branding_favicon
  get 'branding/apple-touch-icon.png' => 'branding#apple_touch_icon', as: :branding_apple_touch_icon
